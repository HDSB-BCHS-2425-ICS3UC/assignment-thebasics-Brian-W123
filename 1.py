...
if Start=="yes":
     ...
     #asks for 2 numbers to add
               ...
               if Operation==("exponent"):
                    ...
                    break
               #if list is inputted this if statement will print available operations and repeat loop
               if Operation==("list"):
                    print("""addition
subtraction
multiplication
...
square root
     """)
                    False
               if Operation==("square root") or ("root"):
                    #asks for 1 number to sqrt
                    sqrt=input("What is the the number? ")
                    #Applys operation
